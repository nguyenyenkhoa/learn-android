package com.example.bai16_buoi6_b1709343_nguyenthiyenkhoa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                nhapurl = (EditText) findViewById(R.id.url);
                String URL = nhapurl.getText().toString();
                try {
                    postParams.put("mssv", "b1709343");
