...
class Connectivity {
    ...
    public static String ShowNotify(Context context) {
        ...
        if (info == null) {
            result = "No default network is currently active";
        }

        if (!info.isConnected()) {
            result = "Network is not connected";
        }
