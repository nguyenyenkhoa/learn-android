...
public class BarChart5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Des5 = intent.getStringExtra("tencot5"); // Lấy tên cột 4
        ...
        textView5.setText("4-" + Des4); // Hiển thị tên cộ 3
        textView5.setText("5-" + Des4); // Hiển thị tên cộ 3
        ...
        l.setXEntrySpace(4f);
        setDataBar1(5, 100);
        mChart.setData(databar1); //Đã khai báo ở trên BarData databar3;
        mChart.setVisibility(View.VISIBLE);
        mChart.invalidate();
    }
    private void setDataBar1(int count, float range) {
        XAxis xAxis= mChart.getXAxis();
        ...
        for (int i = 0; i < count ; i++) {
            double mult = (range);
            double val2 = (double) (Y3[i]);
            yVals1.add(new BarEntry(i+1, (float)(val2)));
        }
        BarDataSet set1;
        ...
        int startColor5 = ContextCompat.getColor(this, android.R.color.holo_purple);
        ...
        dataSets.add(set1);
        databar1 = new BarData(dataSets);
        databar1.setValueTextSize(15f);
        databar1.setBarWidth(0.5f);
    }
}
