...
public class BarChart4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l.setXEntrySpace(4f);
        setDataBar2(4, 100);
        mChart.setData(databar2); //Đã khai báo ở trên BarData databar3;
    ...
    private void setDataBar2(int count, float range) {
        ...
        for (int i = 0; i < count ; i++) {
            ...
            yVals2.add(new BarEntry(i+1, (float)(val3)));
        }
        BarDataSet set1;
        set1 = new BarDataSet(yVals2, "The year 2019");
