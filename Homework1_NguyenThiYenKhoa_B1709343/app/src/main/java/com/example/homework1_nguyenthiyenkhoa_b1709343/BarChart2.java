...
public class BarChart2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l.setTextSize(11f);
        l.setXEntrySpace(4f);
        setDataBar4(2, 100); // Xem hàm ở dưới
        mChart.setData(databar4); //Đã khai báo ở trên BarData databar4;
    ...
    private void setDataBar4(int count, float range) {
        ...
        dataSets.add(set1);
        databar4 = new BarData(dataSets); // Lớp BarData ở trong MPAmdroidChart
